#
# Be sure to run `pod lib lint ApexDataCollect-Util.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yuanfangzhuye/ApexDataCollect-Util'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yuanfangzhuye' => '371551077@qq.com' }
  s.source           = { :git => 'https://github.com/yuanfangzhuye/ApexDataCollect-Util.git', :tag => s.version.to_s }
